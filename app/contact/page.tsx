...
export default function ContactPage() {
  ...
  if (submitted) {
    return (
      <div className="mx-auto max-w-xl px-4 py-8">
        <h1 className="mb-2 text-3xl font-bold text-[#000080]">Thank you</h1>
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-8">
      <h1 className="mb-2 text-3xl font-bold text-[#000080]">Contact</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="name" className="mb-1 block text-base font-medium text-black">
            Name (optional)
          </label>
          <input
            id="name"
        ...
        <div>
          <label htmlFor="message" className="mb-1 block text-base font-medium text-black">
            Message
          </label>
          <textarea
            id="message"
        ...
        <button
          type="submit"
          className="w-full rounded-xl bg-[#000080] px-6 py-4 text-lg font-semibold text-white border-2 border-black hover:bg-[#0047ab] focus:outline-none focus:ring-2 focus:ring-[#000080] focus:ring-offset-2"
        >
          Send message
        </button>
      </form>
