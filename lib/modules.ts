...
export interface MediaSlot {
   ...
   * path to a WebVTT (.vtt) captions file for this video, e.g.
   * "/captions/module-2-passcode-guide.vtt". Optional so existing
   * videos keep working while caption files are authored one by one.
   * TODO: author real .vtt files for each video src below and wire
   * them in here — this field is intentionally left empty until real
   * caption text is available, since captions must match what is
   * actually said in each video.
   */
  captionsSrc?: string;
}
...
export interface ModuleData {
  /** Which phone type this content is written for. Android modules are separate copies with "-android" appended to the slug. */
...
export const MODULES: ModuleData[] = [
  {
    ...
    "steps": [
      {
        "id": "1",
        "text": "Making the Screen Work for You: Adjust font size, dark mode, and brightness."
      },
      {
        "id": "2",
        "text": "Navigating Without Fear: Practice tap, swipe, and long-press gestures."
      },
      {
        "id": "3",
        "text": "What Happens If I Make a Mistake?: Use Back, Home, or restart."
      },
      {
        "id": "4",
        "text": "Arthur's Aha! Moment: Read comfortably with large text and Dark Mode."
      }
    ],
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "contextualTip": "“Settings” is the grey gear app. Inside Display, Text Size is a slider—move it slowly until reading feels easy. You can always move it back."
          },
          {
            "type": "media",
            "slot": {
          ...
          },
          {
            ...
            "slot": {
              ...
              "slides": [
                {
                  "title": "The Tap",
                  "text": "An illustration of a finger tapping an icon once. To open an app."
                },
                {
                  "title": "The Swipe",
                  "text": "An arrow showing a finger sliding across the glass. To turn the page."
                },
                {
                  "title": "The Long-Press",
                  "text": "A finger holding down until a menu pops up. For extra options."
                }
              ]
            }
          },
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "slot": {
              "type": "image",
              "description": "Illustration titled Digital and Physical Security: physical lock on a door, Elena using her phone in the kitchen, and digital lock with bank card and fingerprint on a smartphone.",
  ...
  },
  {
    ...
    "steps": [
      {
        "id": "1",
        "text": "What is 2FA?: Learn the Two-Key Rule: something you know and something you have."
      },
      {
        "id": "2",
        "text": "Task: Turning on 2FA for your Apple ID: Turn on two-factor authentication and confirm your phone number for security codes."
      },
      {
        "id": "3",
        "text": "Integrating 2FA into Your Daily Life: Trusted devices, staying safe on public computers, and automatic code filling from Messages."
      },
      {
        "id": "4",
        "text": "Best Practices for 2FA Management: Backup codes, MFA fatigue, and keeping authenticator apps backed up."
      }
    ],
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "slot": {
              "type": "image",
              "description": "Illustration titled Two-Factor Authentication: laptop with email and password, plus phone with authenticator code, equals unlocked access with treasure chest and sign-in.",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "slot": {
              "type": "video",
              "description": "A screen recording of a login page asking for a 2FA code. A text message arrives at the top of the screen. Above the iPhone keyboard, a grey box appears with the code. The finger taps the box, and the numbers automatically fill into the website.",
  ...
  },
  {
    ...
    "scenario": "Setting Boundaries for Your Digital Guests. The Elena Story: Elena downloaded a new Weather App to plan her garden. Suddenly, a box popped up asking for permission to see her Photos and Contacts. Elena thought, \"Why does a weather app need to see my grandkids' pictures?\" This module teaches Elena how to say No to nosy apps.",
    "estimatedMinutes": 22,
    "steps": [
      {
        "id": "1",
        "text": "What are App Permissions?: Your phone is like your home; apps are guests. Learn the key permissions—including Background App Refresh—and when each makes sense."
      },
      {
        "id": "2",
        "text": "The Rule of Least Access: Only give an app the bare minimum. If a request feels nosy, tap Don't Allow."
      },
      {
        "id": "3",
        "text": "Task: How to Take Back a Key (iPhone): Use Settings → Privacy & Security to review and turn off permissions app by app."
      },
      {
        "id": "4",
        "text": "App Download Safety: Check the developer, review counts, and red flags before you tap Get in the App Store."
      },
      {
        "id": "5",
        "text": "The Permission Request Checklist: Three questions to ask before you tap Allow on any new app."
      }
    ],
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "slot": {
              "type": "image",
              "description": "Hand-drawn iPhone Settings screen for Weather App: Allow Weather App to Access lists Location (While Using), Siri & Search, Notifications, Background App Refresh, and Cellular Data with toggles.",
      ...
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "slot": {
              "type": "video",
              "description": "A slow-paced screen recording of an iPhone. It follows the path: Settings > Privacy & Security > Microphone. It shows a list of apps, and a finger toggles Off a game that was using the mic. Text overlay: You are the boss of your data.",
  ...
  },
  {
    ...
    "steps": [
      {
        "id": "1",
        "text": "Why Updates Matter: Updates patch holes in your phone's code. They fix security problems and keep your device running smoothly."
      },
      {
        "id": "2",
        "text": "Checking for Updates: Open Settings > Software Update. Tap 'Check for Update.' If one is available, install when on Wi-Fi and charging."
      },
      {
        "id": "3",
        "text": "Enabling Automatic Updates: Turn on 'Install Automatically' so updates happen overnight. Your phone will update while you sleep."
      },
      {
        "id": "4",
        "text": "The Monthly Safety Checklist: Once a month: check for updates, delete one unused app, confirm your cloud backup worked."
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      {
        "id": "1",
        "text": "Public Wi-Fi Risks: In a library or café, Wi-Fi is 'open'—others could see what you do. Browsing news? Safe. Logging into your bank? Wait until you're home."
      },
      {
        "id": "2",
        "text": "Recognising Secure Websites: Look at the address bar. 'https://' and a padlock icon mean the site is secure. No padlock? Don't enter passwords."
      },
      {
        "id": "3",
        "text": "What a VPN Is: A VPN creates a private tunnel through public Wi-Fi. In a VPN app, tap Connect—the shield turns from grey to blue when active."
      }
    ],
  ...
  },
  {
    ...
    "steps": [
      {
        "id": "1",
        "text": "What Is a Cache?: The cache stores things you use often so the phone loads faster. Over time it can slow things down. Clearing it helps."
      },
      {
        "id": "2",
        "text": "Cookies & History: Clear your browsing data to remove digital footprints. In your browser settings, select 'Cookies' and 'History' to delete."
      },
      {
        "id": "3",
        "text": "Private Browsing Mode: Incognito or Private mode means the browser won't remember where you went. But your internet provider still knows—use it for privacy from others on your device."
      }
    ],
  ...
  {
    "platform": "android",
    "slug": "getting-comfortable-android",
    "title": "Getting Comfortable with Your Device",
    "scenario": "Learn to make your device work for you—from reading text clearly to fixing mistakes without fear.",
    "estimatedMinutes": 15,
    "steps": [
  ...
  {
    "platform": "android",
    "slug": "first-line-of-defence-android",
    "title": "Your First Line of Defence",
    "scenario": "Elena, an active grandmother, once left her phone at a park while chasing her grandson. She was terrified that someone could see her private photos or access her banking. In this module, we turn Elena's phone into a digital vault so she can enjoy her day with peace of mind.",
    "estimatedMinutes": 20,
    "steps": [],
  ...
  {
    "platform": "android",
    "slug": "public-wifi-browsing-android",
    "title": "Public Wi-Fi & Safe Browsing",
    "scenario": "Public Wi-Fi is convenient but not always safe. Learn when to browse and when to wait.",
    "estimatedMinutes": 12,
    "steps": [
  ...
  {
    "platform": "android",
    "slug": "caches-cookies-clutter-android",
    "title": "Caches, Cookies & Digital Clutter",
    "scenario": "Clear the digital clutter. Your cache is like a pantry—sometimes it needs a clean-out.",
    "estimatedMinutes": 10,
    "steps": [
